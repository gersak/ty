     ...
     :children [[:div.relative
                 [:ty-popup
                  ...
                  [:div.p-4.ty-elevated.rounded-lg
                   [:h4.ty-text++.font-bold.mb-2 "Popup Content"]
                   [:p.ty-text- "Click the button to toggle this popup."]
                   [:ty-button.mt-2
                    {:size "sm"
                     :on {:click #(toggle-popup! :demo-popup)}}
                    "Close"]]]]]})
     ...
     :children [[:div
                 [:ty-popup
                  ...
                  [:ty-button {:slot "anchor"
                   ...
                   "Open Popup"]
                  [:div.p-4.ty-elevated.rounded-lg.border.ty-border
                   [:h4.ty-text++.font-bold.mb-2 "Click Outside Demo"]
                   [:p.text-sm.ty-text-
     ...
     :children [[:div
                 [:ty-popup {:open (popup-open? :interactive-demo)
                  ...
                  [:ty-button {:slot "anchor"
                   ...
                   "Open Form"]
                  [:div.p-4.ty-elevated.rounded-lg.border.ty-border.w-64
                   [:h4.ty-text++.font-bold.mb-3 "Quick Form"]
                   [:div.space-y-3
