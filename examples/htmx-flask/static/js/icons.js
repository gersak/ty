/**
 * Icon Registration for Flask + HTMX + Ty Components Demo
 * 
 * This file registers all the icons used throughout the demo application.
 * Icons are provided as SVG strings and registered with the Ty icon system.
 */

// Wait for Ty components to be loaded before registering icons
document.addEventListener('DOMContentLoaded', function() {
    // Ensure ty.icons is available
    if (typeof ty === 'undefined' || !ty.icons) {
        console.error('Ty components not loaded. Icons cannot be registered.');
        return;
    }

    console.log('📦 Registering icons for Ty Components Demo...');

    // Define icons as SVG strings (using Lucide icons for consistency)
    const icons = {
        // Core UI Icons
        ...
        // Navigation Icons
        "edit": '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M7 7H6a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h9a2 2 0 0 0 2-2v-1"/><path d="M20.385 6.585a2.1 2.1 0 0 0-2.97-2.97L9 12v3h3l8.385-8.415z"/><path d="M16 5l3 3"/></svg>',
        ...
        "calendar-check": '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M8 2v4"/><path d="M16 2v4"/><path d="M21 11.5V6a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h7.5"/><path d="M3 10h18"/><path d="m15 20 2 2 4-4"/></svg>',
        ...
        "users": '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="m22 21-3-3a4 4 0 0 0 0-8"/></svg>',
        ...
        "trash": '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 6h18"/><path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"/><path d="M8 6V4c0-1 1-2 2-2h4c0-1 1-2 2-2v2"/></svg>',
        ...
        // Media Icons
        "play": '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="5,3 19,12 5,21"/></svg>',
        ...
        "stop": '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="18" x="3" y="3" rx="2" ry="2"/></svg>',
        ...
        "triangle": '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M13.73 4a2 2 0 0 0-3.46 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3Z"/></svg>',
        ...
        // Special Icons
        "zap": '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="13,2 3,14 12,14 11,22 21,10 12,10"/></svg>',
        
        "zap-off": '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="12.41,6.75 13,2 10.57,4.92"/><polyline points="18.57,12.91 21,10 15.66,10"/><polyline points="8,8 3,14 12,14 11,22 16,16"/><line x1="2" x2="22" y1="2" y2="22"/></svg>',
        
        "sparkles": '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m12 3-1.912 5.813a2 2 0 0 1-1.275 1.275L3 12l5.813 1.912a2 2 0 0 1 1.275 1.275L12 21l1.912-5.813a2 2 0 0 1 1.275-1.275L21 12l-5.813-1.912a2 2 0 0 1-1.275-1.275L12 3Z"/><path d="M5 3v4"/><path d="M19 17v4"/><path d="M3 5h4"/><path d="M17 19h4"/></svg>',
        
        "window": '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="20" height="16" x="2" y="3" rx="2"/><path d="M8 21v-5a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v5"/></svg>',
        ...
        "search-x": '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m13.5 8.5-5 5"/><path d="m8.5 8.5 5 5"/><circle cx="11" cy="11" r="8"/><path d="m21 21-4.35-4.35"/></svg>',
        ...
        // Event and Business Icons - Missing from current set
        "phone": '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>',
        
        "calendar-x": '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M8 2v4"/><path d="M16 2v4"/><path d="M21 13V6a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h8"/><path d="M3 10h18"/><path d="m17 17 4 4"/><path d="m21 17-4 4"/></svg>',
        ...
        "wifi-off": '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20h.01"/><path d="M8.5 16.429a5 5 0 0 1 7 0"/><path d="M5 12.859a10 10 0 0 1 5.17-2.69"/><path d="M19 12.859a10 10 0 0 0-2.007-1.523"/><path d="M2 9.059a15 15 0 0 1 4.992-2.351"/><path d="M22 9.059a15 15 0 0 0-4.992-2.351"/><path d="m2 2 20 20"/></svg>',
    ...
    // Register all icons with Ty
    ty.icons.add(icons);

    const iconCount = Object.keys(icons).length;
    console.log(`✅ Successfully registered ${iconCount} icons:`, Object.keys(icons).sort().join(', '));
    
    // Dispatch a custom event to let the application know icons are ready
...
// Export function for manual icon registration if needed
window.registerTyIcons = function(additionalIcons = {}) {
    if (typeof ty === 'undefined' || !ty.icons) {
        console.error('Ty components not loaded. Icons cannot be registered.');
        return false;
    }
    
    ty.icons.add(additionalIcons);
    console.log(`📦 Added ${Object.keys(additionalIcons).length} additional icons`);
    return true;
};
...
window.checkTyIcon = function(iconName) {
    ...
    const icon = ty.icons.getIcon(iconName);
    console.log(`🔍 Icon "${iconName}":`, icon ? 'Available ✅' : 'Not found ❌');
    return !!icon;
};

// Helper function to list all available icons
window.listTyIcons = function() {
    if (typeof ty === 'undefined' || !ty.icons) {
        console.error('Ty components not loaded.');
        return [];
    }
    
    // This would need to be implemented in the Ty icons system
    // For now, we'll maintain a list here
    const registeredIcons = [
        'home', 'settings', 'search', 'check', 'x', 'plus', 'minus', 'menu',
        'sun', 'moon', 'edit', 'layers', 'calendar', 'calendar-check', 'calendar-days',
        'user', 'users', 'bell', 'mail', 'check-circle', 'x-circle', 'alert-circle', 'info',
        'eye', 'eye-off', 'trash', 'save', 'chevron-down', 'chevron-up', 'chevron-left', 'chevron-right',
        'arrow-left', 'arrow-right', 'play', 'pause', 'stop', 'file', 'folder', 'download', 'upload',
        'refresh-cw', 'copy', 'link', 'share', 'code', 'server', 'database', 'terminal',
        'circle', 'square', 'triangle', 'github', 'heart', 'star', 'zap', 'zap-off',
        'sparkles', 'window', 'clipboard', 'search-x', 'more-horizontal', 'more-vertical',
        'layout-grid', 'mouse-pointer', 'tag',
        // New event-specific icons
        'phone', 'calendar-x', 'book-open', 'target', 'wifi-off', 'alert-triangle',
        'cloud', 'activity', 'message-circle', 'thumbs-up', 'gift'
    ];
    
    console.log('📋 Available Ty icons:', registeredIcons.sort());
