// Initialize Ty icon registry for Next.js app
// This script will run after Ty components are loaded

export function initializeIcons() {
  if (typeof window !== 'undefined' && window.ty && window.ty.icons) {
    console.log('Initializing Ty icons for Next.js app...');
    
    // Add basic icons for testing
    window.ty.icons.add({
    ...
    console.warn('Ty icons system not found. Make sure @gersak/ty is loaded first.');
    return false;
  }
}
