...
(defn navigate!
  ...
  ([route-id params]
   (let [{:keys [tree base]} @*router*
     ...
     (println "NAVIGATING: " component-url)
     (when component-url
...
; Removed navigate-to-fragment!, get-current-fragment, and setup-fragment-navigation!
; These are no longer needed with unified router approach

; Removed - replaced by unified router approach
