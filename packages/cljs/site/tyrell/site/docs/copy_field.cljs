(ns tyrell.site.docs.copy-field
  ...
  (:require [tyrell.site.docs.common :refer [code-block attribute-table event-table doc-section example-section docs-page]]))
    ...
    [:div.grid.gap-4
     ...
     [:div
      [:ty-copy {:label "Website URL"
                 :value "https://tyrell.gersak.dev"}]]

     [:div
      [:ty-copy {:label "Git Clone URL"
                 :value "git clone https://github.com/gersak/tyrell.git"
                 :format "code"}]]
...
<ty-copy label=\"Install Command\" value=\"npm install tyrell-components\" format=\"code\"></ty-copy>
<ty-copy label=\"Website URL\" value=\"https://tyrell.gersak.dev\"></ty-copy>
<ty-copy label=\"Git Clone URL\" value=\"git clone https://github.com/gersak/tyrell.git\" format=\"code\"></ty-copy>
