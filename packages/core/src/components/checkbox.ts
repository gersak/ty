 ...
 * ```
 */
export class TyCheckbox extends TyComponent<CheckboxState> implements TyCheckboxElement {
  ...
  protected render(): void {
    ...
    if (!container) {
      ...
      checkboxIcon.innerHTML = this.checked ? CHECKBOX_CHECKED_ICON : CHECKBOX_UNCHECKED_ICON
