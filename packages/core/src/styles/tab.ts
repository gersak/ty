 ...
 * 
 * Styles for the ty-tab individual panel component including:
 * - Dynamic sizing based on parent dimensions
...
:host {
  /* Panel takes dimensions from parent ty-tabs via CSS variables */
...
/* Inactive tabs are still rendered (for carousel) but not interactable */
